...
import com.example.submission1.api.FileUploadResponse
...
class AddStoryActivity : AppCompatActivity() {
    ...
    private fun unggahFoto(loginSession: LoginSession) {
        if (getFile != null && binding.textFieldEdit.text.toString().trim().isNotEmpty()) {
            showLoading(true)
            ...
            Toast.makeText(this@AddStoryActivity, "Silakan masukkan berkas gambar atau deskripsi terlebih dahulu.", Toast.LENGTH_SHORT).show()
        }
